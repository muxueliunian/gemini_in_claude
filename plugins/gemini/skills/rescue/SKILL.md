...
- Leave the model unset unless the user explicitly asks for one. The companion does not validate model ids — `agy models` is the source of truth. Ids seen on agy 1.1.16 include `gemini-3.7-flash-high`, `gemini-3.7-flash-medium`, `gemini-3.7-flash-low`, `gemini-3.6-flash-high`, `gemini-3.6-flash-medium`, `gemini-3.6-flash-low`, `gemini-3.5-flash-*`, `gemini-3.1-pro-high`, `gemini-3.1-pro-low`, `claude-sonnet-4-6`, `claude-opus-4-6-thinking`, `gpt-oss-120b-medium`. If agy rejects a model id, report its error verbatim instead of guessing a replacement.
